...
namespace MeePoint.Controllers
{
    public class RegisteredUsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RegisteredUserID,Email,PasswordHash,Username")] RegisteredUser registeredUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RegisteredUserID,Email,PasswordHash,Username")] RegisteredUser registeredUser)
        {
