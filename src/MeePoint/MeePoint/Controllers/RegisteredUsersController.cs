...
namespace MeePoint.Controllers
{
	public class RegisteredUsersController : Controller
	{
		...
		//[System.Web.Mvc.ChildActionOnly] // ãção não pode ser pedida através de um url
		public ActionResult UserName()
		{
			string userName = "Manuel"; // assign value to adminName variable
			return Content(userName);
		}

		//[System.Web.Mvc.ChildActionOnly] // action cannot be requested directly via URL
		public ActionResult UserProfilePic()
		{
			return Content("xd");
		}
